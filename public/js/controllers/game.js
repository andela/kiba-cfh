...
.controller('GameController', ['$scope','$http', '$q', 'game', '$timeout', '$location', 'MakeAWishFactsService', '$dialog', function ($scope, $http, $q, game, $timeout, $location, MakeAWishFactsService, $dialog) {
